...
| 1.7 | 屬性模板 | ✅ | 完整 CRUD | 6 命令 | 18 種子數據 | v1.2.2 完成 |
| 1.8 | 實體屬性值 | ✅ | 批次創建時填寫 | 2 命令 | 表已建 | v1.2.2 完成 |
...
| 日期 | 版本 | 更新內容 |
|------|------|----------|
| 2026-05-05 | **v1.2.2** | **配方審計 + 屬性模板**：<br>• 合併票據類型到票據模板<br>• 屬性模板完整 CRUD（前端+後端）<br>• 配方新增後自動顯示詳情<br>• 配方編號自動生成 (RCP001...)<br>• 示例配方初始化功能 |
| 2026-04-30 | **v1.2.1** | **信息流安全審計**：<br>• 安全邊界強化<br>• 遙測系統完善<br>• 打印安全收斂 |
| 2026-04-28 | **v1.2.0** | **架構優化版**：<br>• React Router 路由化<br>• Hooks 框架完善<br>• 統一類型定義 |
